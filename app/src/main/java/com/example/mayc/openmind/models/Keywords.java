...
public class Keywords {
    ...
    String [] other = {
            "equality", "bullying", "diversity", "inclusion", "stereotypes", "integration",
            "minority", "prejudices", "tokenism", "victim", "privilege", "oppress", "injustice",
            "disparity"
    };

    String [] gender = {
            "abortion", "body", "gender", "gender equality", "derived rights", "discrimination",
            ...
            "transsexual", "woman", "cisgender", "neutral", "androgyny"
    };
